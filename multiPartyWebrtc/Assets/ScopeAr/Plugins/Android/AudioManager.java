...
// source: https://cs.chromium.org/chromium/src/third_party/webrtc/examples/androidapp/src/org/appspot/apprtc/AppRTCAudioManager.java
/*
...
/**
 * AudioManager manages all audio related parts of the AppRTC demo.
 */
public class AudioManager {
    ...
    private final BluetoothAudioManager bluetoothManager;
    ...
    public AudioManager(Context context) {
        ...
        bluetoothManager = BluetoothAudioManager.create(context, this);
    ...
    public void updateAudioDeviceState() {
        ...
        if (bluetoothManager.getState() == BluetoothAudioManager.State.HEADSET_AVAILABLE
                || bluetoothManager.getState() == BluetoothAudioManager.State.HEADSET_UNAVAILABLE
                || bluetoothManager.getState() == BluetoothAudioManager.State.SCO_DISCONNECTING) {
        ...
        if (bluetoothManager.getState() == BluetoothAudioManager.State.SCO_CONNECTED
                || bluetoothManager.getState() == BluetoothAudioManager.State.SCO_CONNECTING
                || bluetoothManager.getState() == BluetoothAudioManager.State.HEADSET_AVAILABLE) {
        ...
        if (bluetoothManager.getState() == BluetoothAudioManager.State.HEADSET_UNAVAILABLE
        ...
        boolean needBluetoothAudioStop =
                (bluetoothManager.getState() == BluetoothAudioManager.State.SCO_CONNECTED
                        || bluetoothManager.getState() == BluetoothAudioManager.State.SCO_CONNECTING)
                        && (userSelectedAudioDevice != AudioDevice.NONE
                        && userSelectedAudioDevice != AudioDevice.BLUETOOTH);
