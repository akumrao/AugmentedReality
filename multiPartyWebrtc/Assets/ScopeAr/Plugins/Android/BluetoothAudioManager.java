...
// source: https://cs.chromium.org/chromium/src/third_party/webrtc/examples/androidapp/src/org/appspot/apprtc/AppRTCBluetoothManager.java
/*
...
public class BluetoothAudioManager {
    ...
    private final AudioManager appAudioManager;
    @Nullable
    ...
    /** Construction. */
    static BluetoothAudioManager create(Context context, AudioManager audioManager) {
        return new BluetoothAudioManager(context, audioManager);
    }

    protected BluetoothAudioManager(Context context, AudioManager audioManager) {
        Log.d(TAG, "ctor");
        apprtcContext = context;
        appAudioManager = audioManager;
