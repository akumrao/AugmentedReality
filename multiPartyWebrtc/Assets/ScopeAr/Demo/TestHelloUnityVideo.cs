...
// 
public class TestHelloUnityVideo : IVideoChatClient
{
   ...
   // private IRtcEngine mRtcEngine;
    ...
    public void join(string channel)
    {
        ...
        int streamID = mRtcEngine.CreateDataStream(true, true);
         Debug.LogError("initializeEngine done, data stream id = " + streamID);
        */
    }
    ...
    public void onSceneLoaded()
    {
       ...
       GameObject quad = GameObject.Find("Quad");
        ...
        {
             Debug.LogError("BBBB: failed to find Quad");
            return;
        }
        else
        {
        ...
        {
             Debug.LogError("BBBB: failed to find Cube");
            return;
        }
        else
        {
    ...
    // this is what is used for the standard Demo project, where a dynamic
    // raw image is created to host the remoate video stream.
    private void onUserJoined_Old(uint uid, int elapsed)
    {
         Debug.LogError("onUserJoined: uid = " + uid + " elapsed = " + elapsed);
